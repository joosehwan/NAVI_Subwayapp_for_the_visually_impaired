...
//    public static final String startExitString = "몇번 출구에서 출발 하시나요?";
    ...
    public static final String nowStationString = "현재 위치한 역을 말씀해주세요";
//    public static final String destExitString= "몇번 출구로 나가시나요?";
    ...
    static final ArrayList<String> emCallArray = new ArrayList<String>(Arrays.asList(senario.nowStationString));

    static final public String getI(int i){
        return senarioArray.get(i);
    }
    static final public String getI2(int i){
        return emCallArray.get(i);
    }
