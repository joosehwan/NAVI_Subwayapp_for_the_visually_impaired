...
import org.tensorflow.navi.env.SplitTimer;
...
public class TensorFlowYoloDetector implements Classifier {
    ...
    public static ArrayList<String> clone;
...
//    Log.e("gridWidth", "=========================gridWidth? : " + gridWidth);
//    Log.e("gridHeight", "=========================gridHeight? : " + gridHeight);
        final float[] output =
...
//          Log.e("bitmap.getHeight", "=========================bitmap.getHeight()? : " + bitmap.getHeight());
        ...
        if (labellist.size() != 0) {    //복사본 저장. DetectorActivity.java로 넘기기 위함.
            clone = (ArrayList<String>) labellist.clone();
        }
        labellist.clear();
//      --------------------------------------------------------------------------------------------
