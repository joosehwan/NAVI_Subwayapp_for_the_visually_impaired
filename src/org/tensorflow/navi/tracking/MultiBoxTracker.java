...
package org.tensorflow.navi.tracking;
...
import org.tensorflow.navi.Classifier.Recognition;
...
//    final List<String> resultLabel = new LinkedList<String>();



    ArrayList<String> resultLabel = new ArrayList<>();
    public ArrayList<String> getResultLabel() {
        return resultLabel;
    }
...
//            Log.e("result=", "" + " " + result.getTitle());
            resultLabel.add(result.getTitle());
        }


//        Iterator iter = resultLabel.iterator(); //Iterator 선언
//
//        for (String i : resultLabel) { //for문을 통한 전체출력
